README.TXT file for the 2015 SAIPE State and County Estimates FTP Directory

I.    File Organization:

    The files in the estmod15 data directory contain estimates of poverty and income
    for 2015. There is one data file for each state with data for all 2015 statistics.  
    Additionally, there is one file that includes the data for the US and states, and 
    one file that includes the data for the US, states, and counties. 
 
  ------------------------------------------------------------------------

II.   File Names

        est15ALL.txt      (for US and all states and counties)
        est15US.txt       (for US with state data [but no county data])
        est15_[STATE].txt (for state with county data)
